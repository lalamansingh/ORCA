...
const providerLabel=(provider:{status:string}|undefined):DependencyStatus=>provider?.status==="operational"?"operational":provider?.status==="unavailable"?"offline":"not_checked";
