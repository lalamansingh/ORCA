...
import { Anchor, Bell, Bot, ChartNoAxesCombined, ChevronDown, Clock3, History, LayoutDashboard, Map, Menu, Navigation, Route, Settings, ShieldAlert, Smartphone, X } from "lucide-react";
...
const navigation=[
  ...
  {href:"/mobile",label:"Mobile PWA App",icon:Smartphone},
