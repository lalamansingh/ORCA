...
export default function Home() {
  return <main className="orca-landing">
    <nav><Link href="/" className="landing-brand"><img src="/icon-192.png" alt="ORCA" width={32} height={32} style={{ objectFit: "contain", background: "#ffffff", borderRadius: "8px", padding: "2px" }} /> ORCA</Link><Link href="/login">Sign in <ArrowUpRight size={16}/></Link></nav>
    ...
    </div><aside className="ocean-orbit" aria-label="ORCA connects environmental evidence and deterministic risk assessment"><div className="orbit-ring"/><div className="orbit-center"><img src="/icon-512.png" alt="ORCA" width={64} height={64} style={{ objectFit: "contain", background: "#ffffff", borderRadius: "14px", padding: "6px", boxShadow: "0 4px 16px rgba(0,0,0,0.25)" }} /><strong>ORCA</strong><span>Question → Evidence → Decision support</span></div><span className="orbit-label orbit-one">Ocean conditions</span><span className="orbit-label orbit-two">Geospatial context</span><span className="orbit-label orbit-three">Deterministic risk</span></aside></section>
