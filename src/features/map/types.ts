...
export type MarineLayerId="pfz"|"sst"|"chlorophyll"|"waves"|"currents"|"weather"|"alerts"|"boundaries"|"restricted"|"protected"|"route"|"saved";
export type LayerStatus="DEMO"|"NOT_CONNECTED"|"UNAVAILABLE";
