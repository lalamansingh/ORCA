...
{id:"alerts",name:"Marine Alerts",description:"Official normalized alert geometry when supplied.",category:"Weather & Safety",enabled:true,available:true,dataStatus:"NOT_CONNECTED",legend:"Severity-labelled advisory geometry",source:"Configured alert providers",color:"#d95d16"},
