...
class PlannerTool(StrEnum):
    WEATHER="WEATHER"; MARINE="MARINE"; ALERTS="ALERTS"; RISK="RISK"; PFZ="PFZ"; OCEAN_PRODUCTS="OCEAN_PRODUCTS"; GEOSPATIAL="GEOSPATIAL"; GEOFENCE="GEOFENCE"; ROUTE="ROUTE"; MAP="MAP"
