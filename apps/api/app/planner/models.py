...
class PlannerTool(StrEnum):
    WEATHER="WEATHER"; MARINE="MARINE"; ALERTS="ALERTS"; RISK="RISK"; PFZ="PFZ"; OCEAN_PRODUCTS="OCEAN_PRODUCTS"; GEOSPATIAL="GEOSPATIAL"; MAP="MAP"
class PlannerIntent(StrEnum):
    WEATHER_QUERY="WEATHER_QUERY"; MARINE_CONDITIONS_QUERY="MARINE_CONDITIONS_QUERY"; MARINE_RISK_QUERY="MARINE_RISK_QUERY"; PFZ_QUERY="PFZ_QUERY"; ALERT_QUERY="ALERT_QUERY"; OCEAN_PRODUCTIVITY_QUERY="OCEAN_PRODUCTIVITY_QUERY"; MAP_QUERY="MAP_QUERY"; ROUTE_QUERY="ROUTE_QUERY"; MULTI_INTENT="MULTI_INTENT"; GENERAL_INFORMATION="GENERAL_INFORMATION"; UNKNOWN="UNKNOWN"
...
class IntentSignals(BaseModel):
    mentions_safe: bool=False; mentions_pfz: bool=False; mentions_weather: bool=False; mentions_waves: bool=False; mentions_alert: bool=False; mentions_chlorophyll: bool=False; mentions_map: bool=False; mentions_route: bool=False
