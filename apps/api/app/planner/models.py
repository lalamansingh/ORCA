...
class PlannerTool(StrEnum):
    WEATHER="WEATHER"; MARINE="MARINE"; ALERTS="ALERTS"; RISK="RISK"; PFZ="PFZ"; PFZ_RECOMMENDATION="PFZ_RECOMMENDATION"; OCEAN_PRODUCTS="OCEAN_PRODUCTS"; GEOSPATIAL="GEOSPATIAL"; GEOFENCE="GEOFENCE"; ROUTE="ROUTE"; MAP="MAP"
class PlannerIntent(StrEnum):
    WEATHER_QUERY="WEATHER_QUERY"; MARINE_CONDITIONS_QUERY="MARINE_CONDITIONS_QUERY"; MARINE_RISK_QUERY="MARINE_RISK_QUERY"; PFZ_QUERY="PFZ_QUERY"; PFZ_RECOMMENDATION_QUERY="PFZ_RECOMMENDATION_QUERY"; ALERT_QUERY="ALERT_QUERY"; OCEAN_PRODUCTIVITY_QUERY="OCEAN_PRODUCTIVITY_QUERY"; GEOFENCE_QUERY="GEOFENCE_QUERY"; MAP_QUERY="MAP_QUERY"; ROUTE_QUERY="ROUTE_QUERY"; MULTI_INTENT="MULTI_INTENT"; GENERAL_INFORMATION="GENERAL_INFORMATION"; UNKNOWN="UNKNOWN"
