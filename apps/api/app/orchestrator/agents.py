...
AGENT_NAMES={PlannerTool.WEATHER:"WeatherAgent",PlannerTool.MARINE:"MarineAgent",PlannerTool.ALERTS:"AlertAgent",PlannerTool.RISK:"RiskAgent",PlannerTool.PFZ:"PFZAgent",PlannerTool.PFZ_RECOMMENDATION:"PFZRecommendationAgent",PlannerTool.OCEAN_PRODUCTS:"OceanProductAgent",PlannerTool.GEOSPATIAL:"GeospatialAgent",PlannerTool.GEOFENCE:"GeofenceAgent",PlannerTool.ROUTE:"RouteAgent",PlannerTool.MAP:"MapActionAgent"}
