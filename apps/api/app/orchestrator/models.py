...
class ORCAState(TypedDict, total=False):
    query_id: str; trace_id: str; raw_query: str; language: str; intent: str; execution_plan: dict[str,Any]; selected_location: dict[str,Any]|None; requested_time: str|None; weather: dict[str,Any]|None; marine: dict[str,Any]|None; alerts: dict[str,Any]|None; risk: dict[str,Any]|None; pfz: dict[str,Any]|None; ocean_products: dict[str,Any]|None; geospatial: dict[str,Any]|None; geofence: dict[str,Any]|None; map_actions: list[dict[str,Any]]; evidence: list[dict[str,Any]]; step_results: dict[str,dict[str,Any]]; errors: list[dict[str,Any]]; warnings: list[str]; execution_status: str; started_at: str; completed_at: str|None
