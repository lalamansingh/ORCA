...
def test_initial_metadata_contains_persistence_models() -> None:
    expected = {"users", "conversations", "messages", "saved_locations", "marine_alerts", "potential_fishing_zones", "marine_zones", "marine_routes", "alert_subscriptions", "marine_query_logs", "data_source_logs"}
...
def test_spatial_models_use_postgis_geometry_columns() -> None:
    ...
    assert PotentialFishingZone.__table__.c.geometry.type.geometry_type == "MULTIPOLYGON"
